...
var config = {
	...
	attrData: "data-hcd",
	attrInit: "data-hci",
	promiseLoader: window.System && window.System.import.bind(window.System) || function (id) {
...
function htmlcomponent(id, rest) {
	...
	config.promiseLoader(id).then(function (c) {
		if (typeof c == "function") c.apply(this, args);else if (typeof c == "object" && typeof c["default"] == "function") c["default"].apply(this, args);
	});
}
